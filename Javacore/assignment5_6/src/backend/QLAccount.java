...
public class QLAccount {
    ...
    public static boolean insertAccount(String username, String fullName, String email, int departmentId, int positionId) {
        try {
            Connection connection = JDBCUtils.getConnection();
            String sql = """
    ...
    public static boolean updateAccount(int id, String newFullName) {
        try {
            Connection connection = JDBCUtils.getConnection();
            String sql = """
                    update accounts
    ...
    public static List<Account> findAccountByUsername(String searchName) {
        List<Account> accounts = new ArrayList<>();
        try {
            Connection connection = JDBCUtils.getConnection();
            String sql = """
